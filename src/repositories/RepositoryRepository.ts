// src/repositories/RepositoryRepository.ts
 ...
 *
 * Used during org-level repo sync (future phases).
 * Phase 1 stores repository identity directly on the integrations table.
 */
    ...
    async create(repository: Repository): Promise<Repository> {
        const query = `
            INSERT INTO repositories (
                id, organization_id, external_id, name, full_name,
                clone_url, default_branch, language, visibility,
